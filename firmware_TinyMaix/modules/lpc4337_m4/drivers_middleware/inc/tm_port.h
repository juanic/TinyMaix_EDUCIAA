...
/******************************* PORT CONFIG  ************************************/
#define TM_ARCH         TM_ARCH_ARM_SIMD//TM_ARCH_O0
...
#define  TM_GET_US()       (uint32_t)cyclesCounterToUs(cyclesCounterRead())

#define TM_DBGT_INIT()     uint32_t _start,_finish;float _time;_start=0;cyclesCounterConfig(EDU_CIAA_NXP_CLOCK_SPEED);//cyclesCounterReset();
#define TM_DBGT_START()    cyclesCounterReset();_start=TM_GET_US();
